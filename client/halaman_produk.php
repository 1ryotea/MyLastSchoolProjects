...
<div class="container">
    <div class="row">
        ...
        <div class="col-6">
            ...
            <p><i class="fa-solid fa-tag small text-secondary"> Produk Pribadi</i></p> <!-- Menampilkan keterangan produk pribadi -->
            <p><h1><b>Rp.<?php echo number_format($nominal)?></b></h1></p>
            <p ><h5 class="text-secondary small">Lokasi: <?php echo $lokasi?></h5></p><hr class="solid">
