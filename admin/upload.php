  ...
  <form action="../admin/upload_produk-admin.php" method="POST" enctype="multipart/form-data">
  ...
  <div class="col">
      <div class="mb-3">
          ...
          <input class="form-control" type="file" id="formFile" name="foto_product-admin" onchange="previewFile()">
      </div>
  </div>
  <script>
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="exampleFormControlInput1" name="nama_produk-admin">
  </div>
  </div>
  </div>
  ...
  <div class="mb-3">
    ...
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="deskripsi_produk-admin"></textarea>
  </div>   
  <div class="mb-3">
  ...
  <div class="row g-3 align-items-center">
    <div class="col-auto">
      <label for="nominal" class="col-form-label">$</label>
    </div>
    <div class="col-1">
      <input type="nominal" id="nominal" class="form-control" aria-describedby="passwordHelpInline" name="nominal-admin">
      </div>
      <div class="col-1">
      <label for="tipe" class="form-label">Tipe Produk</label>
      <select class="form-select" id="tipe" name="tipe-admin">
  ...
  <button class="btn btn-primary" type="submit" name="upload_barang-admin">Upload</button>
